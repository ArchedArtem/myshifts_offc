...
export default function AdminPushScreen() {
    ...
    try {
      ...
      Alert.alert(
        ...
        targetMode === 'all'
          ...
          : `Push отправлены выбранному пользователю. Доставлено на ${result.sentCount} устройство(а).`,
      );
      setTitle('');
      setBody('');
      setEmailQuery('');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Админ-push уведомления</Text>
      <Text style={styles.subtitle}>Можно отправлять всем пользователям или конкретному пользователю по email.</Text>
